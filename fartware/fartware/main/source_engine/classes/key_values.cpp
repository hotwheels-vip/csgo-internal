...
c_key_values::c_key_values( const char* sz_key_name, void* p_unknown1, int h_case_insensitive_key_name )
{
	static auto constructor = reinterpret_cast< void( __thiscall* )( void*, const char*, void*, int ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 56 8B F1 33 C0 8B 4D 0C 81" ) );
...
{
	static auto destructor = reinterpret_cast< void( __thiscall* )( void*, int ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "56 8B F1 E8 ? ? ? ? 8B 4E 14" ) );
	destructor( this, 1 );
}

void* c_key_values::operator new( std::size_t n_alloc_size )
{
	return memory.m_key_values_system->alloc_key_values_memory( n_alloc_size );
}
...
{
	return memory.m_key_values_system->get_string_for_symbol( this->m_key_name_case_sensitive1 | ( this->m_key_name_case_sensitive2 << 8 ) );
}

c_key_values* c_key_values::from_string( const char* name, const char* value )
{
	static auto original_from_string = memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 83 E4 F8 81 EC 0C 05" );
                                     ...
                                     get_symbol_proc_fn pfn_evaluate_symbol_proc )
{
	static auto original_load_from_buffer =
		reinterpret_cast< void( __thiscall* )( void*, const char*, const char*, void*, const char*, void*, void* ) >(
			memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89" ) );
                                   ...
                                   get_symbol_proc_fn pfn_evaluate_symbol_proc )
{
	static auto original_load_from_file = reinterpret_cast< bool( __thiscall* )( void*, void*, const char*, const char*, void* ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 83 E4 F8 83 EC 14 53 56 8B 75 08 57 FF" ) ); // @xref: "rb"
...
c_key_values* c_key_values::find_key( const char* key_name, const bool create )
{
	static auto original_find_key = reinterpret_cast< c_key_values*( __thiscall* )( void*, const char*, bool ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 83 EC 1C 53 8B D9 85 DB" ) );
...
const char* c_key_values::get_string( const char* key_name, const char* default_value )
{
	static auto original_get_string = reinterpret_cast< const char*( __thiscall* )( void*, const char*, const char* ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC 83 E4 C0 81 EC ? ? ? ? 53 8B 5D 08" ) );
...
void c_key_values::set_string( const char* key_name, const char* string_value )
{
	...
	static auto original_set_string = reinterpret_cast< void( __thiscall* )( void*, const char* ) >(
		memory.m_modules[ e_module_names::client ].find_pattern( "55 8B EC A1 ? ? ? ? 53 56 57 8B F9 8B 08 8B 01" ) );
